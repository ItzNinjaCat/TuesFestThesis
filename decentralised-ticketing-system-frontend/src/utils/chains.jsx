...
export const CHAINS = {
  ...
  10: {
    urls: [
      process.env.INFURA_KEY ? `https://optimism-mainnet.infura.io/v3/${process.env.INFURA_KEY}` : '',
  ...
  69: {
    urls: [
      process.env.INFURA_KEY ? `https://optimism-kovan.infura.io/v3/${process.env.INFURA_KEY}` : '',
  ...
  421611: {
    urls: [
      process.env.INFURA_KEY ? `https://arbitrum-rinkeby.infura.io/v3/${process.env.INFURA_KEY}` : '',
